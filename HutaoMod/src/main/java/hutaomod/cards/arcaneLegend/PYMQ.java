...
import hutaomod.powers.arcaneLegends.PYMQPower;

public class PYMQ extends HuTaoCard {
    public static final String ID = PYMQ.class.getSimpleName();
    ...
    public void onUse(AbstractPlayer p, AbstractMonster m, int yyTime) {
        addToBot(new ApplyPowerAction(p, p, new PYMQPower()));
    }
}
