...
import hutaomod.powers.arcaneLegends.WJZHPower;

public class WJZH extends HuTaoCard {
    public static final String ID = WJZH.class.getSimpleName();
    ...
    public void onUse(AbstractPlayer p, AbstractMonster m, int yyTime) {
        addToBot(new ApplyPowerAction(p, p, new WJZHPower()));
    }
}
