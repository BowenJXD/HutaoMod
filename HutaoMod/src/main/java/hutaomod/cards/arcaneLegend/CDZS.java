...
import hutaomod.powers.arcaneLegends.CDZSPower;

public class CDZS extends HuTaoCard {
    public static final String ID = CDZS.class.getSimpleName();
    ...
    public void onUse(AbstractPlayer p, AbstractMonster m, int yyTime) {
        addToBot(new ApplyPowerAction(p, p, new CDZSPower()));
    }
}
