...
import hutaomod.powers.arcaneLegends.KZZRSMZSPower;

public class KZZRSMZS extends HuTaoCard {
    public static final String ID = KZZRSMZS.class.getSimpleName();
    ...
    public void onUse(AbstractPlayer p, AbstractMonster m, int yyTime) {
        addToBot(new ApplyPowerAction(p, p, new KZZRSMZSPower()));
    }
}
