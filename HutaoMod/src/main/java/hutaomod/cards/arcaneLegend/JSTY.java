...
import hutaomod.powers.arcaneLegends.JSTYPower;

public class JSTY extends HuTaoCard {
    public static final String ID = JSTY.class.getSimpleName();
    ...
    public void onUse(AbstractPlayer p, AbstractMonster m, int yyTime) {
        addToBot(new ApplyPowerAction(p, p, new JSTYPower()));
    }
}
