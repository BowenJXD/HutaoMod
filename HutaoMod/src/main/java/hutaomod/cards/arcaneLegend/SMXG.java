...
import hutaomod.powers.arcaneLegends.SMXGPower;

public class SMXG extends HuTaoCard {
    public static final String ID = SMXG.class.getSimpleName();
    ...
    public void onUse(AbstractPlayer p, AbstractMonster m, int yyTime) {
        addToBot(new ApplyPowerAction(p, p, new SMXGPower()));
    }
}
