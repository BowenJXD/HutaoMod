...
import hutaomod.powers.arcaneLegends.ZYDXFPower;

public class ZYDXF extends HuTaoCard {
    public static final String ID = ZYDXF.class.getSimpleName();
    ...
    public void onUse(AbstractPlayer p, AbstractMonster m, int yyTime) {
        addToBot(new ApplyPowerAction(p, p, new ZYDXFPower()));
    }
}
