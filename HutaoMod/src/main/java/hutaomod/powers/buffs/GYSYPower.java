...
public class GYSYPower extends BuffPower implements CheckYinYangSubscriber {
    public static final String POWER_ID = HuTaoMod.makeID(GYSYPower.class.getSimpleName());
    
    public GYSYPower(AbstractCreature owner, int amount) {
